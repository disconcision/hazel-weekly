...
- `../pdf/week-in-hazel-001.pdf`: ten-page main issue, revision 2, with clean lossless PNG plates.
- `../pdf/week-in-hazel-001-woodcut.pdf`: matching ten-page edition with ImageGen woodcut facsimiles of those same three captures.
- `../pdf/week-in-hazel-001-style-lab.pdf`: four pages, two thematic art directions. These are two-page studies, not full alternative ten-page issues.
...
Rebuild the pilot with the bundled Python environment, which has reportlab and Pillow. The font path in the builder points at the bundled LibreOffice fonts. On another machine, adjust it to licensed copies of Linux Libertine, Rubik and Liberation Mono.
