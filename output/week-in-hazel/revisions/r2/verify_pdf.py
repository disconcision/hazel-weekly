...
for name,count,treatment in [('week-in-hazel-001.pdf',10,'clean'),('week-in-hazel-001-woodcut.pdf',10,'woodcut'),('week-in-hazel-001-style-lab.pdf',4,'clean')]:
 ...
 if treatment=='clean':
  ...
  if 'style-lab' in name:expected.discard('probes-cards-clean.png')
...
result={'revision':2,'verified_utc':datetime.now(timezone.utc).isoformat(),'metric_reproduction':'Weekly snapshot unchanged from verified revision 1; new open backlog query saved separately.','pdf_checks':checks}
