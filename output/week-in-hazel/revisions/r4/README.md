...
- `../pdf/week-in-hazel-001.pdf`: eleven-page main issue, revision 4, with clean lossless PNG plates.
...
- `PROCESS.md`: actual research history, revision-4 reporting credits, prose edit and typography rationale.
...
Rebuild the pilot with the bundled Python environment, which has reportlab, Pillow and Pyphen (0.18.1 for this revision). The font path in the builder points at the bundled LibreOffice fonts. On another machine, adjust it to licensed copies of Linux Libertine, Rubik and Liberation Mono.
