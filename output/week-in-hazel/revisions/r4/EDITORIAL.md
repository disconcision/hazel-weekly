...
Start with [PRODUCTION.md](PRODUCTION.md) and its linked revision-3 example for the complete reusable brief, visual grammar and preferred Cards stamp exemplar. This charter retains the weekly reporting and continuity policy.
...
Prefer a controlled ragged edge to blanket justification in narrow columns. See PRODUCTION.md for the paragraph spacing, conservative hyphenation and visual proofing rules. New CSS properties are relevant to a future HTML renderer, not to this ReportLab PDF by themselves.
